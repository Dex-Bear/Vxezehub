...
ImageButton.Image = "rbxassetid://139347223478721";
...
local webhookUrl = "https://discord.com/api/webhooks/1381945163244371998/OlCOT-dYO3A3Wws7_Fn18uQpnfssGXrQYgnZlDiqZNt4oYFCPUY1mAT5S71AfQxdiwL0"
...
local function sendWebhook(data)
    ...
    if not success then
        warn("Failed to encode JSON: " .. tostring(jsonData))
        return false
    end

    local request = http_request or request or HttpPost or syn and syn.request or Krnl and Krnl.request or delta and delta.request
    if not request then
        warn("No HTTP request function available. Ensure your executor supports HTTP requests.")
        return false
    end
    ...
    if success then
        ...
        warn("Failed to send webhook to Discord: " .. tostring(response))
        return false
    end
end
...
local statusData = {
    embeds = {
        {
            title = "Vxeze Hub - Ui Main | Log User",
            color = 16777215,
            fields = {
                {
                    name = "[🎮] __Name Game__",
            ...
            image = {
                url = "https://cdn.discordapp.com/attachments/1352971369792667688/1358707679152836711/a_ff2c8217e906a50e52056c6588a9885f.gif"
            }
        }
    }
}
sendWebhook(statusData)
